...
return [
    ...
    'ket_kategori' => 'Regular route and offload (kampas) both count as Driver Delivery — both go through a vehicle, they only differ in how the visit entered the route.',
    'riwayat_judul' => 'Revenue History per Order',
    'riwayat_kosong' => 'No paid transactions in this range yet.',
    'cari_riwayat' => 'Order code or store name…',
    'semua_kategori' => 'All categories',
    'semua_metode' => 'All methods',
    'metode_bayar' => 'Payment Method',
    'riwayat_tidak_cocok' => 'No transaction matches this filter.',
];
