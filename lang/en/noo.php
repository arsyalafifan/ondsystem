...
return [
    ...
    'bukti_lembar_bermaterai' => 'Stamped Agreement Sheet',
    ...
    'petunjuk_bukti_lembar_bermaterai' => 'Photo of the partnership agreement sheet bearing the stamp duty (materai).',
    ...
    'ket_menunggu_rute' => 'NOOs already approved by an admin and not yet on any route. Check the ones to send out together — the rest stay put and can be routed again later with a different date.',
    'tombol_susun_rute' => 'Plan Route',
    'pilih_semua_menunggu' => 'Select all',
    'tombol_susun_rute_terpilih' => 'Plan Route (:jumlah selected)',
    'galat_belum_pilih_calon' => 'Select the prospects to route first.',
    ...
    'ket_pasang' => 'Enter the freezer number (IDN) on the sticker, fill in any store details still missing, then take all the installation photos.',
    ...
    'satuan_freezer' => 'freezers',
    'progres_freezer' => ':selesai of :total stores done · :dus freezers installed',
];
