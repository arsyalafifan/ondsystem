...
return [
    ...
    'bukti_lembar_bermaterai' => '印花稅票協議書',
    ...
    'petunjuk_bukti_lembar_bermaterai' => '拍攝已貼上印花稅票（materai）的合作協議書。',
    ...
    'ket_menunggu_rute' => '已獲管理員核准且尚未排入任何路線的 NOO。勾選要一起配送的項目，其餘會繼續等待，之後仍可用不同日期重新排線。',
    'tombol_susun_rute' => '產生路線',
    'pilih_semua_menunggu' => '全選',
    'tombol_susun_rute_terpilih' => '產生路線（已選 :jumlah 項）',
    'galat_belum_pilih_calon' => '請先勾選要排線的潛在門市。',
    ...
    'ket_pasang' => '填寫冰櫃上黏貼的編號（IDN），補齊尚未填寫的門市資料，然後拍攝全部安裝憑證照片。',
    'atr_idn' => 'IDN／冰櫃編號',
    ...
    'satuan_freezer' => '台冰櫃',
    'progres_freezer' => '已完成 :selesai / :total 家門市 · 已安裝 :dus 台冰櫃',
];
