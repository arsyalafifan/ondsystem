@php
    ...
    $menu = match ($peran) {
        \App\Enums\PeranPengguna::Admin => [
            ...
            ['rute' => 'kunjungan.periode', 'label' => __('nav.visit_sales'), 'ikon' => '🧭'],
            ['rute' => 'kunjungan.penugasan', 'label' => __('nav.penugasan'), 'ikon' => '🗂️'],
        ...
        \App\Enums\PeranPengguna::Sales => [
            ['rute' => 'kunjungan.kunjungi', 'label' => __('nav.mulai_kunjungan'), 'ikon' => '📷'],
            ['rute' => 'kunjungan.tugas', 'label' => __('nav.tugas_saya'), 'ikon' => '🧭'],
            ['rute' => 'pesanan.buat', 'label' => __('nav.input_pesanan'), 'ikon' => '➕'],
